...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces 'summered
   ...
   `(org-level-1 ((,class (:foreground "#ECE193" :weight bold))))
   `(org-level-2 ((,class (:foreground "#D69F65"))))
   `(org-level-3 ((,class (:foreground "#C87446"))))
   `(org-level-4 ((,class (:foreground "#BA4828"))))
   `(org-level-5 ((,class (:foreground "#B15C44"))))
   `(org-level-6 ((,class (:foreground "#A97060"))))
   `(org-level-7 ((,class (:foreground "#A1847C"))))
   `(org-level-8 ((,class (:foreground "#999999"))))
